...
private:
    ...
    void static callbackForegroundRemovalSlider(int, void *);
    ...
    int _foregroundRemovalSlider      = 0;
    ...
    const int _maxForegroundRemoval   = 255;
    ...
    const std::string FOREGROUND_REMOVAL_TRACKBAR_TITLE = "Foreground Removal";
