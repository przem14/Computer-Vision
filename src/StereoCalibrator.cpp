...
void StereoCalibrator::execute() noexcept
{
    ...
    for(i=0;;i++)
    {
        ...
        for( int s = 1; s <= maxScale; s++ )
        {
            ...
            result = cvFindChessboardCorners( timg,
                cvSize(_boardWidth, _boardHeight),
                &temp[0], &count,
        ...
        if( displayCorners )
        {
            ...
            cvDrawChessboardCorners( cimg, cvSize(_boardWidth, _boardHeight),
                &temp[0], count, result );
